...
typedef enum {
  ...
  GR_VALGRIND_REPLACES_MALLOC = VG_USERREQ__VALGRIND_REPLACES_MALLOC,
#else
  GR_VALGRIND_REPLACES_MALLOC = 2,
#endif
#ifdef VALGRIND_GET_TOOLNAME
  GR_VALGRIND_GET_TOOLNAME = VG_USERREQ__VALGRIND_GET_TOOLNAME,
#else
  GR_VALGRIND_GET_TOOLNAME = 3,
#endif
#ifdef VALGRIND_INNER_THREADS
  GR_INNER_THREADS = VG_USERREQ__INNER_THREADS,
#else
  GR_INNER_THREADS = 4,
#endif
...
typedef enum {
  ...
  GR_HG_PTHREAD_MUTEX_INIT_POST = _VG_USERREQ__HG_PTHREAD_MUTEX_INIT_POST,
#else
  GR_HG_PTHREAD_MUTEX_INIT_POST = 1,
#endif
#ifdef VALGRIND_HG_MUTEX_LOCK_PRE
  GR_HG_PTHREAD_MUTEX_LOCK_PRE = _VG_USERREQ__HG_PTHREAD_MUTEX_ACQUIRE_PRE,
#else
  GR_HG_PTHREAD_MUTEX_LOCK_PRE = 2,
#endif
#ifdef VALGRIND_HG_MUTEX_LOCK_POST
  GR_HG_PTHREAD_MUTEX_LOCK_POST = _VG_USERREQ__HG_PTHREAD_MUTEX_ACQUIRE_POST,
#else
  GR_HG_PTHREAD_MUTEX_LOCK_POST = 3,
#endif
#ifdef VALGRIND_HG_MUTEX_UNLOCK_PRE
  GR_HG_PTHREAD_MUTEX_UNLOCK_PRE = _VG_USERREQ__HG_PTHREAD_MUTEX_UNLOCK_PRE,
#else
  GR_HG_PTHREAD_MUTEX_UNLOCK_PRE = 4,
#endif
#ifdef VALGRIND_HG_MUTEX_UNLOCK_POST
  GR_HG_PTHREAD_MUTEX_UNLOCK_POST = _VG_USERREQ__HG_PTHREAD_MUTEX_UNLOCK_POST,
#else
  GR_HG_PTHREAD_MUTEX_UNLOCK_POST = 5,
#endif
#ifdef VALGRIND_HG_MUTEX_DESTROY_PRE
  GR_HG_PTHREAD_MUTEX_DESTROY_PRE = _VG_USERREQ__HG_PTHREAD_MUTEX_DESTROY_PRE,
#else
  GR_HG_PTHREAD_MUTEX_DESTROY_PRE = 6,
#endif
#ifdef VALGRIND_HG_SEM_INIT_POST
  GR_HG_POSIX_SEM_INIT_POST = _VG_USERREQ__HG_POSIX_SEM_INIT_POST,
#else
  GR_HG_POSIX_SEM_INIT_POST = 7,
#endif
#ifdef VALGRIND_HG_SEM_WAIT_POST
  GR_HG_POSIX_SEM_ACQUIRED = _VG_USERREQ__HG_POSIX_SEM_ACQUIRED,
#else
  GR_HG_POSIX_SEM_ACQUIRED = 8,
#endif
#ifdef VALGRIND_HG_SEM_POST_PRE
  GR_HG_POSIX_SEM_RELEASED = _VG_USERREQ__HG_POSIX_SEM_RELEASED,
#else
  GR_HG_POSIX_SEM_RELEASED = 9,
#endif
#ifdef VALGRIND_HG_SEM_DESTROY_PRE
  GR_HG_POSIX_SEM_DESTROY_PRE = _VG_USERREQ__HG_POSIX_SEM_DESTROY_PRE,
#else
  GR_HG_POSIX_SEM_DESTROY_PRE = 10,
#endif
#ifdef VALGRIND_HG_BARRIER_INIT_PRE
  GR_HG_PTHREAD_BARRIER_INIT_PRE = _VG_USERREQ__HG_PTHREAD_BARRIER_INIT_PRE,
#else
  GR_HG_PTHREAD_BARRIER_INIT_PRE = 11,
#endif
#ifdef VALGRIND_HG_BARRIER_WAIT_PRE
  GR_HG_PTHREAD_BARRIER_WAIT_PRE = _VG_USERREQ__HG_PTHREAD_BARRIER_WAIT_PRE,
#else
  GR_HG_PTHREAD_BARRIER_WAIT_PRE = 12,
#endif
#ifdef VALGRIND_HG_BARRIER_RESIZE_PRE
  GR_HG_PTHREAD_BARRIER_RESIZE_PRE = _VG_USERREQ__HG_PTHREAD_BARRIER_RESIZE_PRE,
#else
  GR_HG_PTHREAD_BARRIER_RESIZE_PRE = 13,
#endif
#ifdef VALGRIND_HG_BARRIER_DESTROY_PRE
  GR_HG_PTHREAD_BARRIER_DESTROY_PRE =
      _VG_USERREQ__HG_PTHREAD_BARRIER_DESTROY_PRE,
#else
  GR_HG_PTHREAD_BARRIER_DESTROY_PRE = 14,
#endif
#ifdef VALGRIND_HG_CLEAN_MEMORY
  GR_HG_CLEAN_MEMORY = VG_USERREQ__HG_CLEAN_MEMORY,
#else
  GR_HG_CLEAN_MEMORY = 15,
#endif
#ifdef VALGRIND_HG_CLEAN_MEMORY_HEAPBLOCK
  GR_HG_CLEAN_MEMORY_HEAPBLOCK = _VG_USERREQ__HG_CLEAN_MEMORY_HEAPBLOCK,
#else
  GR_HG_CLEAN_MEMORY_HEAPBLOCK = 16,
#endif
#ifdef VALGRIND_HG_DISABLE_CHECKING
  GR_HG_ARANGE_MAKE_UNTRACKED = _VG_USERREQ__HG_ARANGE_MAKE_UNTRACKED,
#else
  GR_HG_ARANGE_MAKE_UNTRACKED = 17,
#endif
#ifdef VALGRIND_HG_ENABLE_CHECKING
  GR_HG_ARANGE_MAKE_TRACKED = _VG_USERREQ__HG_ARANGE_MAKE_TRACKED,
#else
  GR_HG_ARANGE_MAKE_TRACKED = 18,
#endif
#ifdef VALGRIND_HG_GET_ABITS
  GR_HG_GET_ABITS = _VG_USERREQ__HG_GET_ABITS,
#else
  GR_HG_GET_ABITS = 19,
#endif
#ifdef VALGRIND_HG_GNAT_DEPENDENT_MASTER_JOIN
  GR_HG_GNAT_DEPENDENT_MASTER_JOIN = _VG_USERREQ__HG_GNAT_DEPENDENT_MASTER_JOIN,
#else
  GR_HG_GNAT_DEPENDENT_MASTER_JOIN = 20,
#endif
#ifdef ANNOTATE_HAPPENS_BEFORE
  GR_HG_USERSO_SEND_PRE = _VG_USERREQ__HG_USERSO_SEND_PRE,
#else
  GR_HG_USERSO_SEND_PRE = 21,
#endif
#ifdef ANNOTATE_HAPPENS_AFTER
  GR_HG_USERSO_RECV_POST = _VG_USERREQ__HG_USERSO_RECV_POST,
#else
  GR_HG_USERSO_RECV_POST = 22,
#endif
#ifdef ANNOTATE_HAPPENS_BEFORE_FORGET_ALL
  GR_HG_USERSO_FORGET_ALL = _VG_USERREQ__HG_USERSO_FORGET_ALL,
#else
  GR_HG_USERSO_FORGET_ALL = 23,
#endif
#ifdef ANNOTATE_RWLOCK_CREATE
  GR_HG_PTHREAD_RWLOCK_INIT_POST = _VG_USERREQ__HG_PTHREAD_RWLOCK_INIT_POST,
#else
  GR_HG_PTHREAD_RWLOCK_INIT_POST = 24,
#endif
#ifdef ANNOTATE_RWLOCK_DESTROY
  GR_HG_PTHREAD_RWLOCK_DESTROY_PRE = _VG_USERREQ__HG_PTHREAD_RWLOCK_DESTROY_PRE,
#else
  GR_HG_PTHREAD_RWLOCK_DESTROY_PRE = 25,
#endif
#ifdef ANNOTATE_RWLOCK_ACQUIRED
  GR_HG_PTHREAD_RWLOCK_ACQUIRED = _VG_USERREQ__HG_PTHREAD_RWLOCK_ACQUIRED,
#else
  GR_HG_PTHREAD_RWLOCK_ACQUIRED = 26,
#endif
#ifdef ANNOTATE_RWLOCK_RELEASED
  GR_HG_PTHREAD_RWLOCK_RELEASED = _VG_USERREQ__HG_PTHREAD_RWLOCK_RELEASED,
#else
  GR_HG_PTHREAD_RWLOCK_RELEASED = 27,
#endif
