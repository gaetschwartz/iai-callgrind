...
and commented one see the [library benchmark intro][intro].
...
[intro]:
    https://github.com/gungraun/gungraun/blob/main/benchmark-tests/benches/test_lib_bench/intro/test_lib_bench_intro.rs
