...
```shell
cargo install --version 0.19.3 gungraun-runner
```
...
```shell
cargo install --version 0.19.3 --root /tmp gungraun-runner
...
```shell
cargo binstall gungraun-runner@0.19.3
```
...
[pre-built]: https://github.com/gungraun/gungraun/releases/tag/v0.19.3
