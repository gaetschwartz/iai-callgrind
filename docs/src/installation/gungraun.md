...
```shell
cargo install --version 0.18.2 --root /tmp gungraun-runner
...
```shell
cargo binstall gungraun-runner@0.18.2
```
...
[pre-built]: https://github.com/gungraun/gungraun/releases/tag/v0.18.2
