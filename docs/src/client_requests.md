...
```toml
[dev-dependencies]
gungraun = { version = "0.19.3", features = ["client_requests"] }
```
...
```toml
[dependencies]
gungraun = { version = "0.19.3", default-features = false, features = [
...
[EntryPoint]: https://docs.rs/gungraun/0.19.3/gungraun/enum.EntryPoint.html
[valgrind-client-req]:
